...
void ICACHE_RAM_ATTR3 SX1280_SetPacketParamsLoRa(uint8_t PreambleLength, uint8_t HeaderType,uint8_t _PayloadLength, uint8_t crc,uint8_t InvertIQ);
...
void  ICACHE_RAM_ATTR3 POWER_init(void);
