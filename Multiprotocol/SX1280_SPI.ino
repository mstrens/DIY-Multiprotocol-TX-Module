...
//not tested yet these functions on sx1280
...
* - `POWER_OUTPUT_FIXED` which will provide the value to `SetOutputPower` function
* - default is to use `SetOutputPower` function
/*//////////////////////////////////////////////////
